...
//            Object.assign({ cwd : this.core.PACKAGE, stdio : 'inherit' }, this.options ));
    ...
    async reinstall() {
        ...
        await E.remove(path.join(E.appFolder,'node_modules'));
        E.log('removing package-lock.json');
        await E.remove(path.join(E.appFolder,'package-lock.json'));
        E.log('npm install...');
        await E.spawn('npm'+E.WINCMD_EXT, ['install'], { cwd : E.appFolder, stdio : 'inherit' });
    }
