...
class Darwin extends Core {
	constructor(appFolder, options) {
		...
		gutil.log("Darwin:tasks", this.tasks.platform)
		...
		return new Promise(async (resolve,reject) => {
		    ...
		    await Promise.all(files);
		  	...
		  	if(this.options.DMG){
			  	...
			  	await this.copy(path.join(this.appFolder, resourceFolder , this.name+"-dmg.png"),path.join(this.APP_DIR,'.background/'+this.name+'.png'));
