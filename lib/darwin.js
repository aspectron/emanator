...
class Darwin extends Core {
	constructor(appFolder, options) {
		...
		if(!this.type.NODE){
			this.tasks.platform.push('setup')
			if(!options.DMG)
				this.task.platform.push('archive');
		}
		...
		return new Promise(async (resolve,reject) => {
		    ...
		    await Promise.all(files);
		  	...
		  	if(this.options.DMG){
			  	...
			  	await this.copy(path.join(this.appFolder, resourceFolder , this.name+".png"),path.join(this.APP_DIR,'.background/'+this.name+'.png'));
